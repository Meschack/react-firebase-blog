...
export const PostCard = ({ post }: Props) => {
  return (
    <Link
      ...
      className='m-post-card-grid d-flex flex-direction-column gap-2 align-items-center justify-content-center bg-white rounded-1 p-1'
    >
      <Image
        className='cover rounded-1 bg-black'
        src={post.cover}
        alt={post.title}
        loading='lazy'
      />
      <div className='content d-flex flex-direction-column gap-2 align-items-start justify-content-start py-1 gap-1'>
        ...
        <div className='fw-500 d-flex gap-1 align-items-center justify-content-start text-secondary-400'>
